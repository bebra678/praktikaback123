...
<div class="back">
    ...
    <div class="block4">
        ...
        { ?>
            <div class="people">
                <img src="https://www.google.com/url?sa=i&url=https%3A%2F%2Fru.wikipedia.org%2Fwiki%2F%25D0%2590%25D0%25BD%25D0%25BE%25D0%25BD%25D0%25B8%25D0%25BC&psig=AOvVaw0ydLoVMFML4T540y7O1kII&ust=1695041867935000&source=images&cd=vfe&opi=89978449&ved=0CA4QjRxqFwoTCMjQ_pjZsYEDFQAAAAAdAAAAABAU">
                <div class="text">
                    <p class="text1"><?php echo $el->first_name . ' ' . $el->name . ' ' . $el->second_name ?></p>
                    <p class="text2">Подразделение: <?php echo $el->id_subdivision ?></p>
                    <p class="text2">Должность: <?php echo $el->id_position ?></p>
        ...
        <!--        <div class="panel">-->
        <!--            <div><a href="--><?php //= app()->route->getUrl('/glav') ?><!--">Главная</a></div>-->
        <!--            <div><a href="--><?php //= app()->route->getUrl('/sot') ?><!--">Сотрудники</a></div>-->
        <!--            <div><a href="--><?php //= app()->route->getUrl('/pod') ?><!--">Подразделения</a></div>-->
        <!--            <div><a href="--><?php //= app()->route->getUrl('/dis') ?><!--">Дисциплины</a></div>-->
        <!--        </div>-->
    </div>
</body>
</html>